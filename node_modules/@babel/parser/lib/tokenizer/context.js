...
<<<<<<< HEAD
    if (this.state.value === "of" && !this.state.exprAllowed && prevType !== _types.types._function && prevType !== _types.types._class || this.state.value === "yield" && this.prodParam.hasYield) {
=======
...
<<<<<<< HEAD
  if (prevType === _types.types.dot || prevType === _types.types.questionDot) {} else if (prevType.beforeExpr && prevType !== _types.types.semi && prevType !== _types.types._else && !(prevType === _types.types._return && _whitespace.lineBreak.test(this.input.slice(this.state.lastTokEnd, this.state.start))) && !((prevType === _types.types.colon || prevType === _types.types.braceL) && this.curContext() === types.b_stat)) {
=======
...
_types.types.star.updateContext = function () {
  this.state.exprAllowed = false;
=======
>>>>>>> 782567c486993431d88a7d42ed2c18702ecdfd4f
};